...
const CurrentModal = Modals.Access.Devices.Add
...
export const CreateDeviceModal: FC<I_Props> = ({ callback }) => {
    ...
    } = useForm<I_FormData>({ mode: "onChange" })
    ...
    return (
        <Modal
            name={CurrentModal}
            title={<Text contentKey="add_device" variant="title-1" className="text-neutral-700" weight={600} />}
            closeButton
        >
