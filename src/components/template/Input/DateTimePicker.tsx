...
import { CalendarSearch, CloseCircle } from "iconsax-reactjs"
import { useRef } from "react"
import persian from "react-date-object/calendars/persian"
import gregorian_en from "react-date-object/locales/gregorian_en"
import persian_fa from "react-date-object/locales/persian_fa"
import { useTranslation } from "react-i18next"
import type { DateObject, DatePickerRef } from "react-multi-date-picker"
    ...
    return (
        <div className={clsx(["relative w-full flex items-center", wrapperClassName])}>
            <ReactMultiDatePicker
                ...
                plugins={[<TimePickerPlugin position="bottom" hideSeconds />]}
